...
function initialize(){
    var buttonCheck = document.getElementById("check"); //creo una variable llamada buttonCheck en la que cojo el elemento llamado check en el html
    buttonCheck.addEventListener("click", checkWord); //quiero que ese buttonCheck compruebe la letra al dar click
}
